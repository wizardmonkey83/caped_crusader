...
const dialogueLines = [
    "Location: Wayne Manor, Grand Ballroom. Bruce Wayne is mingling at a charity event hosted by Wayne Enterprises.",
    ...
    "Batman: Hallucinations, paranoia… it sounds like Scarecrow. But this isn’t his usual MO. Any sign of his fear toxin?",
    ...
    "Batman: Agreed. But this setup… it feels calculated. Almost like it’s testing us.",
    "They move further inside. Suddenly, a faint green glow illuminates a nearby display case, casting intricate, shifting patterns on the walls. Batman spots a card placed on a pedestal in the center, inscribed with a riddle.",
    ...
    "Batman: Not just a riddle—it’s a reflection. Scarecrow’s trying to make us see something about Gotham… something that’s always here but never seen directly. Something haunting every corner. It’s fear. The answer is ‘darkness’",
    ...
    "Robin: Riddler!",
    "Batman: You think he’d get better material if he started socializing.",
    ...
    "Batman: They’re not exactly the collaborative type. Let’s just say tonight’s theme is layered.",
    "They proceed deeper into the museum, the green glow following them as the sound of taunting laughter fades away.",
    ...
    "Commissioner Gordon: You’re not wrong. I’ve seen Scarecrow’s work before, but this is on another level. He’s refined it somehow—made it subtler.",
    ...
    "Batman: Stay close. Scarecrow’s work lingers here. If Hatter is in on this, there’s no telling what they’ve set up.",
    "As they move deeper into the ward, they pass cells filled with scattered debris and faded, cryptic graffiti on the walls. Batman pauses to examine the symbols, which appear random but familiar, almost as if echoing themes from Gotham’s underbelly.",
    ...
    "Batman: Robin. Focus. Don’t let Hatter’s tricks get under your skin.",
    ...
    "As Batman says fear, the projector flickers back to life one last time, casting a clear image of a hidden trapdoor in the corner of the room. Batman and Robin exchange a tense look.",
    "Batman: They’ve led us here, and they want us to go further. Whatever they’re doing, they’re drawing us in deeper.",
    "Robin: Well, if they’re waiting for us… let’s not keep them.",
    "Scene: Batman and Robin have descended deeper into Gotham Psychiatric’s basement through the hidden trapdoor. The narrow stairwell opens into a dark, expansive chamber with high ceilings and walls lined with archaic medical equipment. Shadows twist around the room as a dim green light flickers overhead.",
    ...
    "Robin’s gaze flickers, his eyes clouding over, torn between loyalty and something far more conflicted. A shadow of doubt crosses his face as he looks at Batman, as if weighing a decision he can’t quite bring himself to make.",
...
const riddles = [
    ...
    { question: "Three speak without words. The first, an echo of memory. The second, a flicker of presence. The third, a veil that reveals. Only together will they name me.", answer: "fear" },
